...
export default function EatingDetailsScreen() {
  ...
  const getLocationText = (value: string) => {
    const locationMap: { [key: string]: string } = {
      'food_court': 'Student Center Food Court',
      'cafe': 'Campus Cafe',
      'uni_center': 'University Center',
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.header}>Your Dining Details</Text>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.statusContainer}>
          <Text style={styles.statusText}>Looking for dining buddies...</Text>
